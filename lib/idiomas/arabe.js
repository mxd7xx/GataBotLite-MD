...
const smsAvisoEG = () => { return `╰⊱💚⊱ *تم بنجاح* ⊱💚⊱╮\n\n` }
...
//info-gruposofc.js
const smsGrupoOfc1 = () => { return '*◜🌺 المجموعات الرسمية 🌺◞*'}
...
const smsContacto4 = () => { return 'جهة اتصال 𝙳𝙰𝚁𝙺𝙱𝙾𝚃²⁰²³ الرسمية 🐈'}
...
//descargas.js
const smsTiktok = () => { return 'تيك توك قريبا سيكون لديك فيديو'}
...
//_allantilink.js 
const smsTextoYT = () => { return '𝘿 َِ𝘼 َِ𝙍 َِ𝙆 ِ۬𝙓 َ𝘽 َ𝙊 َْ𝙏 𖤐 ↯'} 
...
const smsMenuTotal3 = () => { return "AI / الذكاء الاصطناعي"}
const smsMenuTotal4 = () => { return "التحميلات"}
const smsMenuTotal5 = () => { return "التحويلات"}
...
const smsMenuTotal12 = () => { return "المالك"}

//Error2
const smsMensError1 = () => { return `❕ تقرير الامر ❕`} 
...
smsytserh1, smsytserh2, smsytserh3, smsytserh4, smsytserh5 }
